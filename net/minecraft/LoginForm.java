...
public class LoginForm extends TransparentPanel
{
  ...
  private TransparentButton retryButton = new TransparentButton("RŽssayer");
  ...
  private JPanel buildLoginPanel() {
    ...
    try
    {
      ...
      {
        TransparentLabel accountLink = new TransparentLabel("Besoin d'un compte?SŽrieusement??") { private static final long serialVersionUID = 0L;
  ...
  private TransparentLabel getUpdateLink() {
    TransparentLabel accountLink = new TransparentLabel("Vous devez faire la mise ˆ jour du Launcher!") { private static final long serialVersionUID = 0L;
  ...
  private TransparentPanel buildOfflinePanel()
  {
    ...
    if (!canPlayOffline) {
      loginPanel.add(new TransparentLabel("(Non tŽlŽchargŽ)", 4), "South");
    }
